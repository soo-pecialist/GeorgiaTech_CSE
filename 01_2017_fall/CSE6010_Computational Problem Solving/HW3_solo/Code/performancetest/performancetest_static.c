...
#define N  10   //base array size
#define PN 5  //Performance experiment

/*
 * this file is used to test and compare the performance of the
 * calendar queue. We use a static calendar queue
 */
...
struct PerformanceData  expInfo[PN];
       ...
       srand (time(NULL));
        ...
        //write the result to a csv file
         SaveTOCSV("test_static.csv",expInfo);
